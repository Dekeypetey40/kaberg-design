...
| USER STORY: Social media links | [#6](https://github.com/Dekeypetey40/kaberg-design/issues/6) | As a user, I want clockable social media links, so that I can visit those pages. | [x] | Must Have |
| USER STORY: Like Feature | [#7](https://github.com/Dekeypetey40/kaberg-design/issues/7) | As a user, I want to be able to like posts, so that the post author knows I like their content. | [x] | Must Have |
| USER STORY: Comment Like Feature | [#8](https://github.com/Dekeypetey40/kaberg-design/issues/8) | As a user, I can like other user's comments, so that show which comments I like. | [ ] | Could Have |
| USER STORY: Comment Feature | [#9](https://github.com/Dekeypetey40/kaberg-design/issues/9) | As a user, I can comment on blog posts, so that I can interact with the community. | [x] | Must Have |
| USER STORY: Paginated Post Content | [#10](https://github.com/Dekeypetey40/kaberg-design/issues/10) | As a site user, I want to see paginated content, so that I can easily view the content I want without being overwhelmed. | [x] | Should Have |
| USER STORY: Make an Account | [#11](https://github.com/Dekeypetey40/kaberg-design/issues/11) | As a new user, I can easily make an account for the website, so that I can interact with the community. | [x] | Must Have |
| EPIC: Home Page | [#12](https://github.com/Dekeypetey40/kaberg-design/issues/12) |  As a new user, I want to see a home page that makes the site's purpose clear, so that I can quickly determine if I am interested in the site. | [x] | Must Have |
| USER STORY: Add Tag Feature | [#13](https://github.com/Dekeypetey40/kaberg-design/issues/13) | As a user, I want to be able to add tags to my posts and view other posts' tags, so that users can quickly get an idea of what a post is about. | [x] | Should Have |
| USER STORY: About Page | [#14](https://github.com/Dekeypetey40/kaberg-design/issues/14) | As a user, I can read what the blog is all about, so that I can understand the blog's purpose. | [] | Could Have |
| USER STORY: TTRPG Poll | [#15](https://github.com/Dekeypetey40/kaberg-design/issues/15) | As a user, I can vote for which TTRPG is my favorite, so that I can interact with the community. | [x] | Should Have |
| USER STORY: Write Drafts | [#16](https://github.com/Dekeypetey40/kaberg-design/issues/16) | As an Admin, I can create draft posts, so that I can finish writing a post when I want. | [x] | Should Have |
| USER STORY: One like per user on polls | [#17](https://github.com/Dekeypetey40/kaberg-design/issues/17) | As an admin, I want to users to only be able to vote once on polls, so that my polls' results do not get skewed by individual users. | [x] | Should Have |
| USER STORY: Add CRUD functionality for user comments | [#18](https://github.com/Dekeypetey40/kaberg-design/issues/18) | As a user, I want to be able to edit or delete my comments, so that I can control my own comments. | [x] | Should Have |
| USER STORY: Add Tag Feature | [#19](https://github.com/Dekeypetey40/kaberg-design/issues/19) | As a user, I want to be able to add tags to my posts and view other posts' tags, so that users can quickly get an idea of what a post is about. | [x] | Should Have |
| USER STORY: About Page | [#20](https://github.com/Dekeypetey40/kaberg-design/issues/20) | As a user, I can read what the blog is all about, so that I can understand the blog's purpose. | [] | Could Have |
| USER STORY: TTRPG Poll | [#21](https://github.com/Dekeypetey40/kaberg-design/issues/21) | As a user, I can vote for which TTRPG is my favorite, so that I can interact with the community. | [x] | Should Have |
| USER STORY: Write Drafts | [#22](https://github.com/Dekeypetey40/kaberg-design/issues/22) | As an Admin, I can create draft posts, so that I can finish writing a post when I want. | [x] | Should Have |
| USER STORY: One like per user on polls | [#23](https://github.com/Dekeypetey40/kaberg-design/issues/23) | As an admin, I want to users to only be able to vote once on polls, so that my polls' results do not get skewed by individual users. | [x] | Should Have |
| USER STORY: Add CRUD functionality for user comments | [#24](https://github.com/Dekeypetey40/kaberg-design/issues/24) | As a user, I want to be able to edit or delete my comments, so that I can control my own comments. | [x] | Should Have |
---
